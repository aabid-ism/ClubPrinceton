...
function Landing() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      ...
      >
        <h2 className="text-xl font-bold mb-8 text-black">Sign up</h2>
        ...
        <button
          type="submit"
          className="px-6 py-2 bg-indigo-500 text-white rounded-md hover:bg-indigo-600 cursor-pointer"
        >
          Sign up
        </button>
      </form>
      <div className="text-base mt-8 text-gray-500">
